...
struct Iff_wmv9
{
 ...
 virtual int  __stdcall write(unsigned int framenum,int incsp,const unsigned char * const src[4],const int srcStride[4],void *dst)=0;
 ...
 virtual size_t __stdcall decompress(const unsigned char *src,size_t srcLen,unsigned char* *dst,int *dstStride)=0;
};
