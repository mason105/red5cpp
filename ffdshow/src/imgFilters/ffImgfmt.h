...
extern char_t* csp_getName(const TcspInfo *cspInfo,int csp,char_t *buf,unsigned int len);
extern char_t* csp_getName(int csp,char_t *buf,unsigned int len);
extern int csp_bestMatch(int inCSP,int wantedCSPS,int *rank=NULL);

static __inline void csp_yuv_adj_to_plane(int &csp,const TcspInfo *cspInfo,unsigned int dy,unsigned char *data[4],int stride[4])
{
...
static __inline void csp_yuv_order(int &csp,unsigned char *data[4],int stride[4])
{
...
static __inline void csp_vflip(int &csp,const TcspInfo *cspInfo,unsigned char *data[],int stride[],unsigned int dy)
{
 ...
 switch (csp&FF_CSPS_MASK)
  {
   ...
   case FF_CSP_RGB15:return IMGFMT_RGB15;
   case FF_CSP_RGB16:return IMGFMT_RGB16;
   case FF_CSP_RGB24:return IMGFMT_RGB24;
   case FF_CSP_RGB32:return IMGFMT_RGB32;
   case FF_CSP_BGR15:return IMGFMT_BGR15;
   case FF_CSP_BGR16:return IMGFMT_BGR16;
   case FF_CSP_BGR24:return IMGFMT_BGR24;
   case FF_CSP_BGR32:return IMGFMT_BGR32;
   case FF_CSP_Y800 :return IMGFMT_Y800;
   case FF_CSP_NV12 :return csp&FF_CSP_FLAGS_YUV_ORDER?IMGFMT_NV21:IMGFMT_NV12;
   default          :return 0;
  }
}
