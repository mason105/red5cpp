...
int32_t
Locale::setKeywordValue(const char* keywordName, char *buffer, int32_t bufLen, UErrorCode &status) const
{
	return uloc_setKeywordValue(fullName, keywordName, buffer, bufLen, &status);
}
const char *
