...
enum CONFIG_ERROR CheckSystemCapability(TCFGSYSTEM* system);
enum CONFIG_ERROR CheckMiscConfigurations(TCFGVIDEOEX* video_config);
enum CONFIG_ERROR CheckVideoConfigurations(TCFGVIDEOEX* video_config);		// only check mandetory configurations
enum CONFIG_ERROR CheckVideoConfigurationsEx(TCFGVIDEOEX* video_config);	// full check all possible configurations
enum CONFIG_ERROR CheckAudioConfigurations(AUDIO_CONFIG* audio_config);
